...
architecture STRUCTURE of bluex_alu_ex_0_0_alu_ex is
  ...
  attribute SOFT_HLUTNM of branch_PC_INST_0 : label is "soft_lutpair41";
  ...
  attribute SOFT_HLUTNM of branch_jump_flag_INST_0 : label is "soft_lutpair41";
...
branch_jump_flag_INST_0: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (

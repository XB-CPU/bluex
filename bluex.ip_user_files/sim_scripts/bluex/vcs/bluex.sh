...
design_libs=(xil_defaultlib util_vector_logic_v2_0_3)
...
compile()
{
  ...
  vlogan -work util_vector_logic_v2_0_3 $vlogan_opts +v2k \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bluex xil_defaultlib.glbl -o bluex_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bluex_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key bluex_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bluex_simv.daidir vcs_lib c.obj)

...
/* arithmetic */
`define ALO_ADD			6'b00_0000			//R R[rd]=R[rs]+R[rt]
`define ALO_SUB			6'b00_0010			//R R[rd]=R[rs]-R[rt]
`define ALO_ADDI		6'b00_0001			//I R[rt]=R[rs]+Imm
`define ALO_SUBI		6'b00_0011			//I R[rt]=R[rs]-Imm
// `define ALO_MUL			6'd17			// don't implement
// `define ALO_DVM			6'd16			// don't implement
// `define ALO_MAC			6'd15			// don't implement
/* logic */
`define ALO_NOT			6'b00_1000			//R R[rd]=~R[rs]
`define ALO_ORL			6'b00_1110			//R R[rd]=R[rs]|R[rt]
`define ALO_AND			6'b00_1010			//R R[rd]=R[rs]&R[rt]
`define ALO_XOR			6'b00_1100			//R R[rd]=R[rs]^R[rt]
//? must I implement these below? them can be replaced by two instruction
// consider don't implement
`define ALO_NOTI		6'b00_1001			//I R[rt]=~Imm
`define ALO_ORLI		6'b00_1111			//I R[rt]=R[rs]|Imm
`define ALO_ANDI		6'b00_1011			//I R[rt]=R[rs]&Imm
`define ALO_XORI		6'b00_1101			//I R[rt]=R[rs]^Imm
/* shift */
// shift left logic
`define ALO_SLL			6'b00_0100			//R R[rd]=R[rs]<<R[rt]
`define ALO_SRL			6'b00_0110			//R R[rd]=R[rs]>>R[rt]
`define ALO_SRA			6'b00_0111			//R R[rd]=R[rs]>>>R[rt]
/* branch */
// jump if equal
`define ALO_BEQ			6'b01_1001			//I if(R[rs]==R[rt]) PC=PC+1+Imm
// jump if not equal
`define ALO_BNE			6'b01_0001			//I if(R[rs]!=R[rt]) PC=PC+1+Imm
`define ALO_JMP			6'b01_0101			//J PC=PC+1+Imm
/* compare */

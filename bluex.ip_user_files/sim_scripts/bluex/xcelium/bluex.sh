...
#
# Script generated by Vivado on Fri Dec 22 12:16:43 +0800 2023
...
#
# Usage        : bluex.sh
#                bluex.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bluex.sh [-reset_run]
#                bluex.sh [-reset_log]
#                bluex.sh [-help]
#
...
#                script (type 'bluex.sh -help' for more information).
#
...
design_libs_elab="-libname xil_defaultlib -libname util_vector_logic_v2_0_3 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xil_defaultlib util_vector_logic_v2_0_3)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "bluex.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bluex.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work util_vector_logic_v2_0_3 $xmvlog_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.bluex xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.bluex -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log bluex_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bluex.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bluex.sh [-help]\n\
Usage: bluex.sh [-step]\n\
Usage: bluex.sh [-lib_map_path]\n\
Usage: bluex.sh [-reset_run]\n\
Usage: bluex.sh [-reset_log]\n\
Usage: bluex.sh [-keep_index]\n\
Usage: bluex.sh [-noclean_files]\n\n\

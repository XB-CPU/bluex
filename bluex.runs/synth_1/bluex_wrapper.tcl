...
namespace eval ::optrace {
  variable script "D:/MyWorks/Programs/Verilog/vivado/bluex/bluex.runs/synth_1/bluex_wrapper.tcl"
...
read_xdc D:/MyWorks/Programs/Verilog/vivado/bluex/bluex.srcs/constrs_1/new/timing_constrain.xdc
set_property used_in_implementation false [get_files D:/MyWorks/Programs/Verilog/vivado/bluex/bluex.srcs/constrs_1/new/timing_constrain.xdc]

read_xdc dont_touch.xdc
set_property used_in_implementation false [get_files dont_touch.xdc]
set_param ips.enableIPCacheLiteLoad 1

read_checkpoint -auto_incremental -incremental D:/MyWorks/Programs/Verilog/vivado/bluex/bluex.srcs/utils_1/imports/synth_1/PC.dcp
close [open __synthesis_is_running__ w]

OPTRACE "synth_design" START { }
synth_design -top bluex_wrapper -part xc7z020clg400-2
...
write_checkpoint -force -noxdef bluex_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file bluex_wrapper_utilization_synth.rpt -pb bluex_wrapper_utilization_synth.pb"

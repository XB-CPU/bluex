...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L util_vector_logic_v2_0_3 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bluex xil_defaultlib.bluex xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bluex -key {Behavioral:sim_1:Functional:bluex} -tclbatch cmd.tcl -protoinst "protoinst_files/bluex.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bluex.wdb xsim.dir libdpi.so)

...
#
# Script generated by Vivado on Mon Dec 18 13:19:12 +0800 2023
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bluex xil_defaultlib.bluex xil_defaultlib.glbl -log elaborate.log
}

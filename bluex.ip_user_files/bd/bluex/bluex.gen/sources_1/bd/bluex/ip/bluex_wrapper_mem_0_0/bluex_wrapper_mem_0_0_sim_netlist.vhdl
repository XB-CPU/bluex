...
--               d:/MyWorks/Programs/Verilog/vivado/bluex/bluex.gen/sources_1/bd/bluex/ip/bluex_wrapper_mem_0_0/bluex_wrapper_mem_0_0_sim_netlist.vhdl
...
entity bluex_wrapper_mem_0_0_wrapper_mem is
  port (
  ...
  attribute ORIG_REF_NAME of bluex_wrapper_mem_0_0_wrapper_mem : entity is "wrapper_mem";
end bluex_wrapper_mem_0_0_wrapper_mem;

architecture STRUCTURE of bluex_wrapper_mem_0_0_wrapper_mem is
  signal reg_write_i_1_n_0 : STD_LOGIC;
begin
\alu_result_reg[0]\: unisim.vcomponents.FDCE
     port map (
      C => clk,
      CE => '1',
      CLR => reg_write_i_1_n_0,
      D => alu_result_inw(0),
      Q => alu_result(0)
    );
...
reg_write_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity bluex_wrapper_mem_0_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    reg_write_inw : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of bluex_wrapper_mem_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of bluex_wrapper_mem_0_0 : entity is "bluex_wrapper_mem_0_0,wrapper_mem,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of bluex_wrapper_mem_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of bluex_wrapper_mem_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of bluex_wrapper_mem_0_0 : entity is "wrapper_mem,Vivado 2023.2";
end bluex_wrapper_mem_0_0;

architecture STRUCTURE of bluex_wrapper_mem_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of write_mem_clk : signal is "XIL_INTERFACENAME write_mem_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN bluex_wrapper_mem_0_0_write_mem_clk, INSERT_VIP 0";
begin
  \^clk\ <= clk;
  ...
  write_mem_clk <= \^clk\;
inst: entity work.bluex_wrapper_mem_0_0_wrapper_mem
     port map (
      alu_result(31 downto 0) => \^alu_result\(31 downto 0),
